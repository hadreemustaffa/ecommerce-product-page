...
export const AddToCartButton = ({ onClick }: ButtonProps) => {
  return (
    <button
      onClick={onClick}
      type="button"
      className="flex w-full flex-row items-center justify-center gap-2 rounded-lg bg-orange p-4 font-bold text-white"
    >
      <svg
        width="22"
        height="20"
